      ...
      <table className="w-full min-w-[720px] text-[12px]">
        <thead>
          <tr className="bg-[var(--color-gray-25)]">
            ...
            <th className="border-b border-[var(--color-gray-200)] px-3 py-2.5 text-left text-[11px] font-bold text-[var(--color-gray-400)]">
              렌탈사별 실거래 평균 월렌탈료
            </th>
            <th className="border-b border-[var(--color-gray-200)] px-3 py-2.5 text-right text-[11px] font-bold whitespace-nowrap text-[var(--color-gray-400)]">
              최저–최고 격차
                    ...
                    {r.entries.map((e) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="num ml-[3px] text-[11px] text-[var(--color-gray-400)]">
                            (n{e.count})
                          </span>
                          {isMin ? (
